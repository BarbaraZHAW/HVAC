    ...
    **HVAC composition**:
    ...
    def lin_model(self, θs0):
       ...
       θo,φo=>[MX1]==0==||          [MX2]==2==[HC]==F==3==>[TZ]==4==||
        ...
        # MX
        A[0, 0], A[0, 6], b[0] = m * c, -(m - mo) * c, mo * c * θo
        A[1, 1], A[1, 7], b[1] = m * l, -(m - mo) * l, mo * l * wo
        # HC
        A[2, 0], A[2, 2], A[2, 9], b[2] = m * c, -m * c, 1, 0
        A[3, 1], A[3, 3], b[3] = m * l, -m * l, 0
        #VH
        A[4, 2], A[4, 4], b[4] = m * c, -m * c, 0
        A[5, 3], A[5, 5], A[5, 8], b[5] = m * l, -m * l, 1, 0
        #TZ
        A[6, 4], A[6, 6], A[6, 8], b[6] = m * c, -m * c, Ql, 0
        A[7, 5], A[7, 7], A[7, 9], b[7] = m * l, -m * l, Qs, 0
        # Kθ indoor temperature controller
        A[9, 2], A[9, 6], b[9] = Kθ, 1, Kθ * θIsp
        # Kw indoor humidity ratio controller
        A[8, 3], A[8, 7], b[8] = Kw, 1, Kw * psy.w(θIsp, φIsp)
